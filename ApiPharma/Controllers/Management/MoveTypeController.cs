...
public class MoveTypeController : BaseController
{
    ...
    {
        var moveTypes = await _unitOfWork.MoveTypes.GetAllAsync();
        /* return Ok(moveTypes); */
    ...
    {
        var moveType = await _unitOfWork.MoveTypes.GetByIdAsync(id);
        if (moveType == null)
        {
            return NotFound();
        }
    ...
    public async Task<ActionResult<MovementType>> Post(MoveTypeDto moveTypeDto)
    {
        ...
        this._unitOfWork.MoveTypes.Add(moveType);
    ...
    public async Task<ActionResult<MoveTypeDto>> Put(int id, [FromBody] MoveTypeDto moveTypeDto)
    {
        ...
        moveTypeDto.Id = moveType.Id;
        _unitOfWork.MoveTypes.Update(moveType);
        await _unitOfWork.SaveAsync();
        return moveTypeDto;
    }
    ...
    public async Task<ActionResult> Delete(int id)
    {
        ...
        _unitOfWork.MoveTypes.Remove(moveType);
        await _unitOfWork.SaveAsync();
        return NoContent();
    }
}