...
public class PersonContController : BaseController
{
    ...
    {
        var perContats = await _unitOfWork.PerContacts.GetAllAsync();
    ...
    {
        var perContact = await _unitOfWork.PerContacts.GetByIdAsync(id);
        if (perContact == null)
        {
            return NotFound();
        }
    ...
    public async Task<ActionResult<PersonContact>> Post(PersonContPDto personContPDto)
    {
        ...
        this._unitOfWork.PerContacts.Add(perContact);
    ...
    public async Task<ActionResult<PersonContPDto>> Put(int id, [FromBody] PersonContPDto personContPDto)
    {
        ...
        personContPDto.Id = perContact.Id;
        _unitOfWork.PerContacts.Update(perContact);
        await _unitOfWork.SaveAsync();
    ...
    public async Task<ActionResult> Delete(int id)
    {
        ...
        _unitOfWork.PerContacts.Remove(perContact);
        await _unitOfWork.SaveAsync();
        return NoContent();
    }
}