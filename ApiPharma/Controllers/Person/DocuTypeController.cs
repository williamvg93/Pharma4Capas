...
public class DocuTypeController : BaseController
{
    ...
    {
        var docuTypes = await _unitOfWork.DocuTypes.GetAllAsync();
        /* return Ok(docuTypes); */
    ...
    {
        var docuType = await _unitOfWork.DocuTypes.GetByIdAsync(id);
        if (docuType == null)
        {
            return NotFound();
        }
    ...
    public async Task<ActionResult<DocumentType>> Post(DocuTypeDto docuTypeDto)
    {
        ...
        this._unitOfWork.DocuTypes.Add(docuType);
    ...
    public async Task<ActionResult<DocuTypeDto>> Put(int id, [FromBody] DocuTypeDto docuTypeDto)
    {
        ...
        docuTypeDto.Id = docuType.Id;
        _unitOfWork.DocuTypes.Update(docuType);
        await _unitOfWork.SaveAsync();
        return docuTypeDto;
    }
    ...
    public async Task<ActionResult> Delete(int id)
    {
        ...
        _unitOfWork.DocuTypes.Remove(docuType);
        await _unitOfWork.SaveAsync();
        return NoContent();
    }
}