...
namespace ApiPharma.Controllers.Location;
...
public class DepartmentController : BaseController
{
    ...
    {
        var departments = await _unitOfWork.Departms.GetAllAsync();
    ...
    {
        var department = await _unitOfWork.Departms.GetByIdAsync(id);
        if (department == null)
        {
            return NotFound();
        }
    ...
    public async Task<ActionResult<Department>> Post(DepartmentPDto departmentPDto)
    {
        ...
        this._unitOfWork.Departms.Add(department);
    ...
    public async Task<ActionResult<DepartmentPDto>> Put(int id, [FromBody] DepartmentPDto departmentPDto)
    {
        ...
        departmentPDto.Id = department.Id;
        _unitOfWork.Departms.Update(department);
        await _unitOfWork.SaveAsync();
    ...
    public async Task<ActionResult> Delete(int id)
    {
        ...
        _unitOfWork.Departms.Remove(department);
        await _unitOfWork.SaveAsync();
        return NoContent();
    }
}