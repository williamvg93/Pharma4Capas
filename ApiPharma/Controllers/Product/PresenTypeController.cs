...
namespace ApiPharma.Controllers.Product;
...
public class PresenTypeController : BaseController
{
    ...
    {
        var preseTypes = await _unitOfWork.PresenTypes.GetAllAsync();
    ...
    {
        var presenType = await _unitOfWork.PresenTypes.GetByIdAsync(id);
        if (presenType == null)
        {
            return NotFound();
        }
    ...
    public async Task<ActionResult<PresentationType>> Post(PresenTypeDto presenTypeDto)
    {
        ...
        this._unitOfWork.PresenTypes.Add(presenType);
    ...
    public async Task<ActionResult<PresenTypeDto>> Put(int id, [FromBody] PresenTypeDto presenTypeDto)
    {
        ...
        presenTypeDto.Id = presenType.Id;
        _unitOfWork.PresenTypes.Update(presenType);
        await _unitOfWork.SaveAsync();
    ...
    public async Task<ActionResult> Delete(int id)
    {
        ...
        _unitOfWork.PresenTypes.Remove(presenType);
        await _unitOfWork.SaveAsync();
        return NoContent();
    }
}